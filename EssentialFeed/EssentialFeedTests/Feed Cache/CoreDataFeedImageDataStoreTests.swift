...
class CoreDataFeedImageDataStoreTests: XCTestCase {
    ...
    // Note: Deleted since CoreData sync API runs it in a serial Queue
...
//    }
    ...
    // Note: look how the expect function is so more direct know.
    // Coredata is sinc and the infrasturecture tests are more direct
    ...
    private func insert(_ data: Data, for url: URL, into sut: CoreDataFeedStore, file: StaticString = #filePath, line: UInt = #line) {
        ...
        // This expectation will be replaced by turning the FeedCache Sync as well

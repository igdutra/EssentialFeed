...
import EssentialAppLegacy

class FeedLoaderCacheDecoratorTests: XCTestCase, FeedLoaderTestCase {
    
    // Avoid confusion with import of EssentialFeed (todo: remove it)
    typealias FeedLoader = EssentialAppLegacy.FeedLoader
    typealias FeedCache = EssentialAppLegacy.FeedCache
    ...
    private func makeSUT(loaderResult: EssentialAppLegacy.FeedLoader.Result,
                         cache: CacheSpy = .init(),

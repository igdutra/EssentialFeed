...
final class FeedImageDataLoaderCacheDecoratorTests: XCTestCase, FeedImageDataLoaderTestCase {
    /* NOTE
     ...
     Just re-add the basic scenarios, init,
     Also missing the task test case
     but the basic using the expect function, was ok!
    ...
    private func makeSUT(cache: CacheSpy = .init(),
                         file: StaticString = #file, line: UInt = #line) -> (sut: FeedImageDataLoader, loader: FeedImageDataLoaderSpy) {
